...
private:
	...
	struct MenuItem
	{
		MenuItem( TMenuID _id=MENU_NO )
		{
			...
			bFolder=bLink=bPrograms=bAlignBottom=bBreak=bInline=bInlineFirst=bInlineLast=bRecentGrid=bSplit=bHasJumpList=bMetroLink=bMetroApp=bBlankSeparator=bNew=bStartScreen=bCustomAccelerator=false;
			priority=0;
			pItem1=pItem2=NULL;
			mfuHash=0;
			categoryHash=0;
		...
		bool bRecentGrid:1; // 3x3 grid tile (icon only)
