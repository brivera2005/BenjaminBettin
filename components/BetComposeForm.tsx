...
export function BetComposeForm({
  ...
  return (
    <article className="mb-3 rounded-2xl border border-violet-500/30 bg-stone-900/80 p-4 shadow-lg shadow-violet-900/20">
        ...
        <div className="flex gap-1">
          {repeatFrom && (
            <button
              type="button"
              onClick={applyRepeat}
              className="flex h-8 items-center gap-1 rounded-lg px-2 text-[10px] font-bold uppercase tracking-wider text-stone-500 hover:bg-white/5 hover:text-violet-300"
          ...
          <button
            type="button"
            onClick={onCancel}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-stone-500 hover:bg-white/5 hover:text-stone-300"
            aria-label="Cancel"
          >
            <X className="h-4 w-4" />
          </button>
      ...
      <div className="space-y-3">
        <input
          ...
          className="w-full rounded-xl border border-white/10 bg-stone-950/60 px-3 py-2.5 text-sm text-stone-200 outline-none focus:border-violet-500/40"
        />
        <input
          type="text"
          value={values.bet}
          ...
          <label className="block">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-stone-950/60 py-2.5 pl-7 pr-3 text-sm tabular-nums outline-none focus:border-violet-500/40"
              />
            </div>
